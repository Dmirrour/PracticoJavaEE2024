...
a persistence unit "PracticoJavaEE2024PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PracticoJavaEE2024/pom.xml":
